...
void viewdetails(void)
{
	...
	printf("\n101\tBus A\tNahan to Dehradhoon\t\t       Rs.500\t\t9am");
	printf("\n102\tBus B\tNahan to Mandi\t\t   Rs.500\t\t12pm");
	printf("\n103\tBus C\tHamirpur to Chandirgarh\t\t       Rs.450\t\t8am");
	printf("\n104\tBus D\tHamirpur to Nahan\t\tRs.450\t\t11am");
	printf("\n105\tBus E\tHamirpur to Una\t\tRs.500\t\t7am");
}
...
void specificbus(int bus_num)
{
	...
	{
		printf("\nBus:\t\t\tBUS A");
		printf("\nDestination:\t\tNahan to Dehradhoon");
		printf("\nDeparture:\t\t9am ");
	}
	if (bus_num==102)
	{
		printf("\nBus:\t\t\tBUS B");
		printf("\nDestination:\t\tNahan to Mandi");
		printf("\nDeparture:\t\t12pm");
	}
	if (bus_num==103)
	{
		printf("\nBus:\t\t\tBUS C");
		printf("\nDestination:\t\tHamirpur to Chandirgarh");
		printf("\nDeparture:\t\t8am");
	}
	if (bus_num==104)
	{
		printf("\nBus:\t\t\tBUS D");
		printf("\nDestination:\t\tHamirpur to Nahan");
		printf("\nDeparture:\t\t11am ");
	}
	if (bus_num==105)
	{
		printf("\nBus:\t\t\tBUS C");
		printf("\nDestination:\t\tHamirpur to Una");
		printf("\nDeparture:\t\t7am");
	}
